 ...
 *
 * Toto je konfiguracni soubor pro CMSIS ovladace pro Kinetis MKL25Z
 * -------------------------------------------------------------------------- */
...
/* Konfigurace pro I2C driver */

/*
 Set RTE_I2C0 to 1 to indicate that it is configured properly
 Define which pins are used by I2C0 module.
 You need to select one of the available  pins
 for the module - see the datasheet,  Pinout chapter
 (in Signal Multiplexing and Signal Descriptions) to find out which
 pins are available for each I2C module.
 Define the name (code) of the pin as defined in pins_<device>.h for your MCU
...
// I2C0_SDA Pin
#define		RTE_I2C0_SDA_PIN	(GPIO_E25)	/* PTA25/5; PTB1/2; PTB3/2; PTC9/2*/
...
// I2C1_SCL Pin
#define		RTE_I2C1_SCL_PIN	(GPIO_E1)	/* PTE1/6; PTA3/2; PTC1/2; PTC10/2*/
#define		RTE_I2C1_SCL_FUNC	(6)

// I2C1_SDA Pin
#define		RTE_I2C1_SDA_PIN	(GPIO_E0)	/* PTE0/6; PTA4/2; PTC2/2; PTC11/2*/
#define		RTE_I2C1_SDA_FUNC	(6)

// Include file for I2C driver if needed
#if (RTE_I2C0 || RTE_I2C1)
#include "I2C_MKL25Z4.H"
#endif



/* -----------------------------------------------------*/
#if 0 /* jd: vse vyrazeno, vybrat nad toto jen potrebne */
